    ...
    <!-- Custome CSS-->    
        <link href="{{asset('/materialize/css/layouts/style-horizontal.css')}}" type="text/css" rel="stylesheet" media="screen,projection">
  ...
  <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->
       ...
       <link href="{{asset('/materialize/js/plugins/sweetalert/dist/sweetalert.css')}}" type="text/css" rel="stylesheet" media="screen,projection">
     <!-- jQuery Library -->
